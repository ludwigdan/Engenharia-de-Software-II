			...
			<div class="row">
				...
				<form name="crudIngrediente" action="<?php echo $action;?>" method="POST">
					<div>
						...
						<input type="text" name="nome" required value="<?php  echo $Ingrediente['descricao'];  ?>"/>
					</div>
					<div>
						<label>Unidade de Medida</label>
						<select name="unidade">
								<option value="Unidade" <?php if ($Ingrediente['unidademedida'] == 'Unidade') echo 'selected'; ?> >Unidade</option>
								<option value="ML" <?php if ($Ingrediente['unidademedida'] == 'ML') echo 'selected'; ?> >ML</option>
								<option value="MG" <?php if ($Ingrediente['unidademedida'] == 'MG') echo 'selected'; ?>>MG</option>
							</select>
					</div>
						<div>
						<label>Porção</label>
						<input type="number" name="porcao" value="<?php  echo $Ingrediente['porcao'];  ?>" required/>
					</div>
						<div>
						<label>Preço</label>
						<input type="text" name="preco" id="preco" onChange="validaPreco(<?php  echo $Ingrediente['preco'];  ?>);" value="<?php  echo $Ingrediente['preco'];  ?>"	 required/>
					</div>
